...
public class Datatypes {
    public static void main(String[] args) {
        ...
        // 문자형 변수 선언
        // - 유니코드(세계 각국의 문자를 0~65535 숫자로 매핑한 국제 표준 규칙) 저장
        char ch = 'A'; // 65 매핑
        char ch2 = '가'; // 44032 매핑
        ...
        // - 기본 자료형은 == 연산자를 통해 비교하지만, String 객체간 비교는 .equals() 메서드를 사용해서 비교해야 함
        ...
        // 클래스 (Class)
        // Person person : person 이라는 변수가 Person 클래스의 인스턴스를 참조할 것이라고 컴파일러에게 알려줌 -> 타입 지정하는 개념!
        // new Person() : Person 클래스의 새로운 인스턴스를 생성하는 부분. new 키워드를 사용하여 새로운 객체를 할당하고, 괄호 안에 생성자에 필요한 인자들을 전달하여 초기화
